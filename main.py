...
new_customer = Customer(first_name="Jan",last_name = "Hatapka", email="jan.hatapka@gmail.com",address="Ul.29.augusta28/c",postcode="81109",country = "Slovakia")
new_customer2 = Customer(first_name="Peter",last_name = "Hrinko", email="jan.hatapka@gmail.com",address="Ul.29.augusta28/c",postcode="81109",country = "Slovakia")
